...
def get_user_inputs():
    ...
    tk.Button(root, text="OK", command=root.quit).grid(row=8, column=0, columnspan=2, pady=6)
    root.mainloop()
...
for year in range(start_year, stop_year + 1):
    ...
    print(f"Saved image as {place_name}_{year}.png")
